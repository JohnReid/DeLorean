...
ggsave('Windram-pseudotime-vs-obfuscated.eps', gp.pseudo + plos.theme,
...
ggsave('Windram-profiles.svg', gp.profiles + plos.theme,
       width=plos.width, height=plos.height, units="in")
ggsave('Windram-profiles.tiff', gp.profiles + plos.theme,
       width=plos.width, height=plos.height, units="in", dpi=300)
ggsave('Windram-profiles-plos.pdf', gp.profiles + plos.theme,
       width=plos.width, height=plos.height, units="in")
...
gp.tau.posterior <- (
    ...
    + scale_color_discrete(name="model\ncapture\ntime")
    + coord_flip())
ggsave('Windram-tau-posterior.eps', gp.tau.posterior + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in")
...
print(gp.post.cor)
ggsave('Windram-posterior-cor.eps', gp.post.cor + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in")
...
ggsave('Windram-roughnesses.eps', gp.roughnesses + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in")
