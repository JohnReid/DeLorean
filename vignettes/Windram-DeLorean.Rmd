...
source(system.file("vignettes/shared.R", package="DeLorean"))
...
ggsave('Windram-pseudotime-vs-obfuscated.eps', plots$pseudo + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in")
ggsave('Windram-pseudotime-vs-obfuscated.pdf', plots$pseudo,
       width=text.width, height=text.width, units="in")
ggsave('Windram-pseudotime-vs-obfuscated.png', plots$pseudo,
...
ggsave('Windram-profiles.pdf', plots$profiles,
       width=text.width * 2, height=text.width * 2, units="in")
ggsave('Windram-profiles.png', plots$profiles,
...
ggsave('Windram-tau-posterior.tiff', plots$tau.posterior + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in", dpi=300)
ggsave('Windram-tau-posterior.eps', plots$tau.posterior + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in")
ggsave('Windram-tau-posterior.pdf', plots$tau.posterior,
       width=text.width, height=text.width,
       units="in")
ggsave('Windram-tau-posterior.png', plots$tau.posterior,
       width=slide.fig.width, height=slide.fig.width / html5$ratio,
       dpi=300, units="in")
# Save best tau
plots$tau.best <- plot(dl, type="pseudotime")
ggsave('Windram-tau-best.pdf', plots$tau.best,
       width=text.width, height=text.width, units="in")
ggsave('Windram-tau-best.png', plots$tau.best,
       width=slide.fig.width, height=slide.fig.width / html5$ratio,
       dpi=300, units="in")
...
ggsave('Windram-posterior-cor.tiff', plots$post.cor + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in", dpi=300)
ggsave('Windram-posterior-cor.eps', plots$post.cor + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in")
ggsave('Windram-posterior-cor.pdf', plot=plots$post.cor,
       width=text.width, height=text.width)
ggsave('Windram-posterior-cor.png', plots$post.cor,
       width=slide.fig.width / 2, height=slide.fig.width / 2 / html5$ratio,
       dpi=300, units="in")
...
ggsave('Windram-roughnesses.tiff', plots$roughnesses + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in", dpi=300)
ggsave('Windram-roughnesses.eps', plots$roughnesses + plos.theme,
       width=plos.width / 2, height=plos.height / 2, units="in")
ggsave('Windram-roughnesses.pdf', plots$roughnesses,
       width=text.width * 2, height=text.width)
ggsave('Windram-roughnesses.png', plots$roughnesses)
