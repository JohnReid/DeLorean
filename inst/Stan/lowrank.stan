...
transformed data {
    #
    # Cholesky decomposition of covariance of inducing pseudotimes
    cholesky_factor_cov[M] KuuChol; # covariance Cholesky decomposition
...
model {
    ...
    for (g in 1:G) {
        expr[g] ~ multi_normal_prec(
            rep_vector(phi[g], C),
            calc_approx_prec(Autau, psi[g], omega[g]));
    }
}
generated quantities {
