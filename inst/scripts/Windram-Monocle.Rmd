...
author: John Reid
bibliography: ../../inst/scripts/DeLorean.bib
...
```{r loadLib}
library(monocle)
.data <- readRDS('Data/Windram-input.rds')
...
ggsave('Windram-Monocle-compare.eps', gp.monocle.pseudo + bioinf.theme,
       width=bioinf.single.w, height=bioinf.single.h, units="in")
