...
```{r geneMeta}
tang.rna.seq.gene.meta <- rna.seq[,1:36] %>% rename(gene=RefSeqID, name=GeneID)
...
```{r expr}
tang.rna.seq <- log10(as.matrix(rna.seq[,as.character(tang.rna.seq.cell.meta$cell)]))
