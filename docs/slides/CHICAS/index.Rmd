...
- Stan provides a Hamiltonian MCMC algorithm: the No-U-Turn sampler.
- Multimodal posterior is difficult to explore.
...
- 48 hour time course, sampled every 2 hours
...
--- .class
## Arabidopsis response to infection
<img src="../Figures/Windram-tau-posterior.png" alt="Windram tau posterior" height="500" width="1000">

--- .class
## Arabidopsis response to infection
<img src="../Figures/Windram-profiles.png" alt="Windram profiles" height="500" width="1000">

--- .class
## Arabidopsis response to infection
<img src="../Figures/Windram-roughnesses.png" alt="Windram roughnesses" height="500" width="500">
...
--- .class
## Paracrine signalling
- Shalek *et al.* (Nature 2014) generated cross-sectional time courses of
the response of primary mouse bone-marrow-derived dendritic
cells to lipopolysaccharide stimulation

--- .class
## Paracrine signalling
<img src="../Figures/Shalek-roughnesses.png" alt="Shalek roughnesses" height="500" width="800">
